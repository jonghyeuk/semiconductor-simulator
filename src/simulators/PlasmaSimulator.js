...
const PlasmaSimulator = () => {
  ...
  function PaschenSchematic() {
    ...
    return (
      <div className="bg-gray-50 rounded-lg border-2 border-gray-300 p-4 w-full" style={{height: '520px'}}>
  ...
  return (
      ...
      <div className="w-full px-6 py-6">
        {activeTheme === 'plasma-basics' && (
          <div className="space-y-4 w-full">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border w-full">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border w-full">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200 w-full">
    ...
    </div>d text-blue-800 mb-4">이온화와 재결합의 동적 평형</h3>
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-6 border border-indigo-200 w-full">
        ...
        {activeTheme === 'plasma-principle1' && (
          <div className="space-y-4 w-full">
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-6 border w-full">
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200 w-full">
        ...
        {activeTheme === 'plasma-principle2' && (
          <div className="space-y-4 w-full">
            <div className="bg-gradient-to-r from-violet-50 to-purple-50 rounded-xl p-6 border w-full">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6 border border-purple-200 w-full">
        ...
        {activeTheme === 'rf-matching' && (
          <div className="space-y-4 w-full">
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border w-full">
        ...
        {activeTheme === 'system-structure' && (
          <div className="space-y-4 w-full">
            <div className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl p-6 border w-full">
