...
import {
  ...
  calculateTotalSimRate as computeTotalSimRate,
  evaluateOxideQuality,
} from '../physics/oxidation';
...
const OxidationSimulator = ({ initialTab }) => {
  ...
  // 계산식은 src/physics/oxidation.js 로 옮겼다. 여기서는 컴포넌트 state 만 묶어 준다.
  const calculateTotalSimRate = () =>
    computeTotalSimRate(simOrientation, simDopingLevel, simInitialOxide, simTemperature, simPressure);
