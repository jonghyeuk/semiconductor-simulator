 ...
 *
 * 출처는 Plummer, "Silicon VLSI Technology" Table 6.2 인데, **그 표는 <111> 값**이다.
 * <100> 을 쓰려면 선형 상수 B/A 의 전인자를 1.68 로 나눠야 한다 (표 각주).
 *   dry  6.23e6 / 1.68 = 3.71e6
 *   wet  1.63e8 / 1.68 = 9.70e7
 * 포물선 상수 B 는 산화종의 확산 律速이라 결정 방위와 거의 무관하므로 그대로 둔다.
 *
 * 이 시뮬레이터는 <100> 기준이다. "영향 인자" 탭의 방위 배율도 100 을 1.0 으로
 * 잡고 있으므로, 코어 모델이 <111> 값이면 방위 보정이 이중으로 걸리는 셈이었다.
 */
const DEAL_GROVE = {
  dry: { B0: 7.72e2, EaB: 1.23, BA0: 3.71e6, EaBA: 2.0 },
  wet: { B0: 3.86e2, EaB: 0.78, BA0: 9.70e7, EaBA: 2.05 },
};
